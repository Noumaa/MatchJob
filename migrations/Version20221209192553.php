 ...
 */
final class Version20221209192553 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , start_date DATE DEFAULT NULL, end_date DATE DEFAULT NULL, created_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        ...
        $this->addSql('INSERT INTO offer (id, user_id, label, money_per_hour, description, duration, start_date, end_date) SELECT id, user_id, label, salary, description, duration, start_date, end_date FROM __temp__offer');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__offer AS SELECT id, user_id, label, money_per_hour, description, duration, start_date, end_date FROM offer');
        $this->addSql('DROP TABLE offer');
        ...
        $this->addSql('INSERT INTO offer (id, user_id, label, salary, description, duration, start_date, end_date) SELECT id, user_id, label, money_per_hour, description, duration, start_date, end_date FROM __temp__offer');
        $this->addSql('DROP TABLE __temp__offer');
        $this->addSql('CREATE INDEX IDX_29D6873EA76ED395 ON offer (user_id)');
    }
}
